...
class DadosRepositorios:
    ...
    def __init__(self, owner):
        ...
        self.access_token='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'
...
ling_mais_usadas_amazon = amazon_rep.cria_df_linguagens()
#print(ling_mais_usadas_amazon)

netflix = DadosRepositorios('netflix')
ling_mais_usadas_netflix = netflix.cria_df_linguagens()


spotify = DadosRepositorios('spotify')
ling_mais_usadas_spotify = spotify.cria_df_linguagens()


#salvando os dados

ling_mais_usadas_amazon.to_csv('dados/linguagens_amzn.csv')
